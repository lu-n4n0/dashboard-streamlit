...
# =============================================================================
# PAGE 5 : ANALYSE APPROFONDIE ET RECOMMANDATIONS
# =============================================================================


elif page == "Analyse et recommandations":
 
    page_header("Analyse approfondie",
                "Cette page repond a la problematique centrale : quel est l'impact des crises de 2025 sur la perception internationale du Benin, et quels leviers de communication peuvent attenuer cet impact ?")
